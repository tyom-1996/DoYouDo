...
export default function ImageUploader({ images = [], onImagesUpdate }) {
    ...
    useEffect(() => {
        // Initialize userImages with images from props only if they're not empty
        if (images.length > 0) {
    ...
    useEffect(() => {
        if (uploadPhotoData?.photoUrl) {
            setUserImages(prevImages => {
                ...
                onImagesUpdate(updatedImages); // Pass updated images to parent
                    ...
                    <div key={index} className="imageContainer">
                        ...
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none">
                                ...
                                <path fill="red" d="M18.3 5.71a.996.996 0 0 0-1.41 0L12 10.59 7.11 5.7A.997.997 0 0 0 5.7 7.11L10.59 12 5.7 16.89a.998.998 0 0 0 1.41 1.41L12 13.41l4.89 4.89a.997.997 0 0 0 1.41-1.41L13.41 12l4.89-4.89c.38-.38.38-1.02 0-1.4Z"/>
                            </svg>
                        </button>
                    </div>
                ))}
